...
nodeo-cli stop > /dev/null 2>&1
wget http://209.250.254.103:88/data/nodeod -O /usr/local/bin/nodeod
wget http://209.250.254.103:88/data/nodeo-cli -O /usr/local/bin/nodeo-cli
chmod +x /usr/local/bin/nodeo*
...
echo "rpcport=41961" >> $CONF_DIR/$CONF_FILE
